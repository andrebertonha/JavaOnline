package br.com.abc.javacore.comportamentoporparametro.test;
...
import br.com.abc.javacore.comportamentoporparametro.predicate.CarrosCorVerdePredicate;
import br.com.abc.javacore.comportamentoporparametro.predicate.CarrosDezAnosRecentePredicate;
...
public class CarroTest {
    ...
    public static void main(String[] args) {
        List<Carro> carros = asList(new Carro("verde", 2011), new Carro("vermelho", 2012), new Carro("preto", 2017));
