...
public class StreamTest5GerandoStreams {
    public static void main(String[] args) {
        ...
        Stream<String> stringStream = Stream.of("William", "Devdojo", "acessem ofacebook");
        System.out.println();
        stringStream.map(String::toUpperCase).forEach(s -> System.out.print(s + " "));

        Stream<String> empty = Stream.empty(); //stream vazia
        ...
        //iterate deve se utilizar limit para nao ficar executando
