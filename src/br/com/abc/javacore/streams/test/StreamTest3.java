...
public class StreamTest3 {
    public static void main(String[] args) {
        ...
        System.out.println(pessoas.stream().noneMatch(pessoa -> pessoa.getIdade() > 18)); //nenhum deles maior q 18
        //.paralallelStream agiliza o processamento quanto se tem mais de 1 processador
